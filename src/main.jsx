  ...
  return (
    <>
      ...
      <header className="topbar">
        ...
        <button className="menuBtn" onClick={() => setOpen(!open)} aria-label="Меню">{open ? <X/> : <Menu/>}</button>
...
function HomePage({ setPage }) {
  return (
    <>
      <Hero eyebrow="v2.1 · React + Vite" title="ГСК «Березка-2» Digital" text="Открытое управление, прозрачные финансы, контроль решений собрания и развитие инфраструктуры.">
  ...
  return (
    <>
      ...
      <section className="panel">
        ...
        <a className="btn primary" href="https://forms.google.com" target="_blank" rel="noreferrer">Открыть форму обращения</a>
      </section>
    </>
  )
}
